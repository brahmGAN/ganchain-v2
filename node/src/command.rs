...
use gpu_runtime::ExistentialDeposit;
...
use {
	gpu_runtime::constants::time::SLOT_DURATION,
...
impl SubstrateCli for Cli {
	...
	fn support_url() -> String {
		"https://github.com/gpu/gpu/issues/new".into()
	}
	...
	fn load_spec(&self, id: &str) -> std::result::Result<Box<dyn sc_service::ChainSpec>, String> {
		let spec = match id {
			"gpu-dev" | "dev" => Box::new(chain_spec::development_config()),
			"gpu-loal" | "local" => Box::new(chain_spec::local_testnet_config()),
			"gpu" | "" => Box::new(chain_spec::gpu_config()?),
			"gpu-testnet" | "testnet" => Box::new(chain_spec::gpu_testnet_config()?),
